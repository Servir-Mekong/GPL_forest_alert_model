...
if __name__ == "__main__":
    ...
    BUFFER_SIZE = 2000
    optimizer = 'ADAM'
    eval_metrics = [custom_metrics.dice_coef, custom_metrics.f1_m, 
    ...
    # Shuffle and set the batch size
    training_ds = training_ds.shuffle(BUFFER_SIZE).batch(BATCH_SIZE).repeat()
    testing_ds = testing_ds.shuffle(BUFFER_SIZE).batch(BATCH_SIZE).repeat()
